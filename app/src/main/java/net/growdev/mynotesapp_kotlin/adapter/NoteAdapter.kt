package net.growdev.mynotesapp_kotlin.adapter
...
import net.growdev.mynotesapp_kotlin.CustomOnItemClickListener
import net.growdev.mynotesapp_kotlin.NoteAddUpdateActivity
import net.growdev.mynotesapp_kotlin.R
