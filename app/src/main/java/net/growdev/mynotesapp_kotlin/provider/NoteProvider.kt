package net.growdev.mynotesapp_kotlin.provider
...
import net.growdev.mynotesapp_kotlin.db.DatabaseContract.AUTHORITY
import net.growdev.mynotesapp_kotlin.db.DatabaseContract.NoteColumns.Companion.CONTENT_URI
import net.growdev.mynotesapp_kotlin.db.DatabaseContract.NoteColumns.Companion.TABLE_NAME
