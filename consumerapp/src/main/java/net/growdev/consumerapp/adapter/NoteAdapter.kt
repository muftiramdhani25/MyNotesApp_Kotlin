package net.growdev.consumerapp.adapter
...
import net.growdev.consumerapp.CustomOnItemClickListener
import net.growdev.consumerapp.NoteAddUpdateActivity
import net.growdev.consumerapp.R
